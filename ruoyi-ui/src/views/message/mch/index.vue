<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="通信秘钥" prop="apiSecret">
        <el-input
    ...
    <el-table v-loading="loading" :data="mchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="通信秘钥" align="center" prop="apiSecret" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="状态" prop="available">
          <el-input v-model="form.available" placeholder="请输入状态" />
        </el-form-item>
        <el-form-item label="备注" prop="description">
          <el-input v-model="form.description" placeholder="请输入备注" />
        </el-form-item>
        <el-form-item label="通信秘钥" prop="apiSecret">
          <el-input v-model="form.apiSecret" placeholder="请输入通信秘钥" />
        </el-form-item>
        <el-form-item label="创建人ID" prop="createById">
...
<script>
import { listMch, getMch, delMch, addMch, updateMch } from "@/api/message/mch";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMch(this.queryParams).then(response => {
        this.mchList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateMch(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addMch(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('message/mch/export', {
        ...this.queryParams
